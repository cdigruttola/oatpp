...
public:
  static std::shared_ptr<ControllerAsync> createShared(
...
ENDPOINT_ASYNC("GET", "params/{param}", GetWithParams) {
 ...
 ENDPOINT_ASYNC_INIT(GetWithParams)
  ...
  Action act() {auto param = request->getPathVariable("param");
...
ENDPOINT_ASYNC("GET", "headers", GetWithHeaders) {
 ...
 ENDPOINT_ASYNC_INIT(GetWithHeaders)
  ...
  Action act() {auto param = request->getHeader("X-TEST-HEADER");
...
ENDPOINT_ASYNC("POST", "body", PostBody) {
 ...
 ENDPOINT_ASYNC_INIT(PostBody)
  ...
  Action act() {// OATPP_LOGV(TAG, "POST body. Reading body...");
...
ENDPOINT_ASYNC("POST", "echo", Echo) {
 ...
 ENDPOINT_ASYNC_INIT(Echo)
  ...
  Action act() {// OATPP_LOGV(TAG, "POST body(echo). Reading body...");
...
ENDPOINT_ASYNC("POST", "test/multipart-all", MultipartUpload)
{
  ...
  Action act() override
  {
    ...
    multipartReader->setPartReader("part2",
                                   multipart::createAsyncFilePartReader("/Users/leonid/Documents/test/my-text-file.tf"));
