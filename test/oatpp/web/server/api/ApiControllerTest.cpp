...
#include OATPP_CODEGEN_BEGIN(ApiController)
  ...
  ENDPOINT("GET", "path/{param1}/{param2}", pathParams, PATH(String, param1), PATH(String, param2))
  {
  ...
  ENDPOINT("GET", "query", queryParams, QUERY(String, param1), QUERY(String, param2))
  {
