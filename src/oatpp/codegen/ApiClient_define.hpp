...
#define AUTHORIZATION_BASIC(TYPE, ...) \
  OATPP_MACRO_API_CLIENT_PARAM(OATPP_MACRO_API_CLIENT_AUTHORIZATION_BASIC, TYPE, (__VA_ARGS__))
...
/**
 * Codegen macoro to be used in classes extending &id:oatpp::web::client::ApiClient; to generate required
 * fields/methods/constructors for ApiClient.
...
#define OATPP_MACRO_API_CLIENT_BODY(TYPE, PARAM_LIST) __body = OATPP_MACRO_FIRSTARG PARAM_LIST;
...
#define OATPP_MACRO_API_CLIENT_AUTHORIZATION(TYPE, PARAM_LIST)                 \
  OATPP_MACRO_API_CLIENT_MACRO_SELECTOR(OATPP_MACRO_API_CLIENT_AUTHORIZATION_, \
                                        TYPE,                                  \
...
#define OATPP_MACRO_API_CLIENT_AUTHORIZATION_BASIC(TYPE, PARAM_LIST)                 \
  OATPP_MACRO_API_CLIENT_MACRO_SELECTOR(OATPP_MACRO_API_CLIENT_AUTHORIZATION_BASIC_, \
                                        TYPE,                                        \
                                        OATPP_MACRO_UNFOLD_VA_ARGS PARAM_LIST)
...
#define OATPP_MACRO_API_CLIENT_PARAM_PUT(INDEX, COUNT, X) OATPP_MACRO_API_CLIENT_PARAM_MACRO X
...
#define OATPP_API_CALL_0(NAME, METHOD, PATH)                                                                           \
  ...
  {                                                                                                                    \
    ...
    return executeRequest(METHOD, Z_getPathPattern_##NAME(PATH), nullptr, nullptr, nullptr, body, __connectionHandle); \
  }
...
#define OATPP_API_CALL_MACRO_0(METHOD, PATH, NAME) OATPP_API_CALL_0(NAME, METHOD, PATH)

#define OATPP_API_CALL_MACRO_1(METHOD, PATH, NAME, ...) OATPP_API_CALL_1(NAME, METHOD, PATH, __VA_ARGS__)
...
#define OATPP_API_CALL_ASYNC_MACRO_0(METHOD, PATH, NAME) OATPP_API_CALL_ASYNC_0(NAME, METHOD, PATH)

#define OATPP_API_CALL_ASYNC_MACRO_1(METHOD, PATH, NAME, ...) OATPP_API_CALL_ASYNC_1(NAME, METHOD, PATH, __VA_ARGS__)
 ...
 * @param PATH - Path to endpoint (without host)
 * @param NAME - Name of the generated method
 * @return - &id:oatpp::async::CoroutineStarterForResult;<const
 * std::shared_ptr<&id:oatpp::web::protocol::http::incoming::Response;>&>.
 */
