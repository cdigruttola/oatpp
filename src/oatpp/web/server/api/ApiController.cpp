...
std::shared_ptr<ApiController::OutgoingResponse> ApiController::handleError(const Status& status,
                                                                            const oatpp::String& message) const
{
  if(m_errorHandler) {
...
void ApiController::setDefaultAuthorizationHandler(
 const std::shared_ptr<handler::AuthorizationHandler>& authorizationHandler)
{
...
std::shared_ptr<ApiController::OutgoingResponse> ApiController::createDtoResponse(
 const Status& status,
