                                                    ...
                                                    const std::shared_ptr<protocol::http::outgoing::Response>& response)
{
  ...
  if(request) {
    ...
    auto connection =
     request->getHeaders().getAsMemoryLabel<oatpp::data::share::StringKeyLabelCI_FAST>(Header::CONNECTION);
...
std::shared_ptr<encoding::EncoderProvider> CommunicationUtils::selectEncoder(
