...
public:
   ...
   * @param str
   */
  MemoryLabel(const std::shared_ptr<base::StrBuffer>& str)
    : MemoryLabel(str, str->getData(), str->getSize())
  {
  }
...
public:
  ...
  StringKeyLabelCI(std::nullptr_t)
    : MemoryLabel()
  {
  }
...
public:
  ...
  StringKeyLabelCI_FAST(std::nullptr_t)
    : MemoryLabel()
  {
  }
