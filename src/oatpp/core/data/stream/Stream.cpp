...
v_io_size WriteCallback::writeSimple(const void* data, v_buff_size count)
{
  ...
  if(!action.isNone()) {
    OATPP_LOGE("[oatpp::data::stream::WriteCallback::writeSimple()]",
               "Error. writeSimple is called on a stream in Async mode.");
    throw std::runtime_error(
     "[oatpp::data::stream::WriteCallback::writeSimple()]: Error. writeSimple is called on a stream in Async mode.");
  }
  return res;
}
...
v_io_size WriteCallback::writeExactSizeDataSimple(data::buffer::InlineWriteData& inlineData)
{
  ...
  while(inlineData.bytesLeft > 0) {
    ...
    if(!action.isNone()) {
      OATPP_LOGE("[oatpp::data::stream::WriteCallback::writeExactSizeDataSimple()]",
                 "Error. writeExactSizeDataSimple() is called on a stream in Async mode.");
      throw std::runtime_error("[oatpp::data::stream::WriteCallback::writeExactSizeDataSimple()]: Error. "
                               "writeExactSizeDataSimple() is called on a stream in Async mode.");
    }
...
async::Action WriteCallback::writeExactSizeDataAsyncInline(data::buffer::InlineWriteData& inlineData,
  ...
  if(inlineData.bytesLeft > 0) {
    ...
    if(res > 0) {
      ...
      default:
        ...
        return new async::Error("[oatpp::data::stream::writeExactSizeDataAsyncInline()]: Error. Unknown IO result.");
      }
    }
  }
...
async::CoroutineStarter WriteCallback::writeExactSizeDataAsync(const void* data, v_buff_size size)
{
  ...
  public:
    WriteDataCoroutine(WriteCallback* _this, const void* data, v_buff_size size)
      : m_this(_this)
...
v_io_size ReadCallback::readExactSizeDataSimple(data::buffer::InlineReadData& inlineData)
{
  ...
  while(inlineData.bytesLeft > 0) {
    ...
    if(!action.isNone()) {
      OATPP_LOGE("[oatpp::data::stream::ReadCallback::readExactSizeDataSimple()]",
                 "Error. readExactSizeDataSimple() is called on a stream in Async mode.");
      throw std::runtime_error("[oatpp::data::stream::ReadCallback::readExactSizeDataSimple()]: Error. "
                               "readExactSizeDataSimple() is called on a stream in Async mode.");
    }
...
async::Action ReadCallback::readExactSizeDataAsyncInline(data::buffer::InlineReadData& inlineData,
                                                         async::Action&& nextAction)
{
  ...
  if(inlineData.bytesLeft > 0) {
    ...
    if(res > 0) {
      ...
      default:
        ...
        return new async::Error("[oatpp::data::stream::readExactSizeDataAsyncInline()]: Error. Unknown IO result.");
      }
    }
  }
  ...
  if(inlineData.bytesLeft > 0) {
    ...
    if(res < 0) {
      ...
      default:
        ...
        return new async::Error("[oatpp::data::stream::readSomeDataAsyncInline()]: Error. Unknown IO result.");
      }
    }
  }
...
v_io_size ReadCallback::readSimple(void* data, v_buff_size count)
{
  ...
  if(!action.isNone()) {
    OATPP_LOGE("[oatpp::data::stream::ReadCallback::readSimple()]",
               "Error. readSimple is called on a stream in Async mode.");
    throw std::runtime_error(
     "[oatpp::data::stream::ReadCallback::readSimple()]: Error. readSimple is called on a stream in Async mode.");
  }
  return res;
}
...
v_int32 StatelessDataTransferProcessor::iterate(data::buffer::InlineReadData& dataIn,
                                      ...
                                      const base::ObjectHandle<data::buffer::Processor>& processor)
{
  ...
  public:
      ...
      if(m_procRes == data::buffer::Processor::Error::PROVIDE_DATA_IN && m_inData.bytesLeft == 0) {
        ...
        if(res > 0) {
          ...
          default:
            ...
            return error<AsyncTransferError>(
             "[oatpp::data::stream::transferAsync]: Error. ReadCallback. Unknown IO error.");
          }
        }
    ...
    Action process()
    {
      ...
      default:
        return error<AsyncTransferError>(
         "[oatpp::data::stream::transferAsync]: Error. ReadCallback. Unknown processing error.");
      }
    }
